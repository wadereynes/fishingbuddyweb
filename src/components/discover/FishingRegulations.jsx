        ...
        <div id='content-wrapper' className='d-flex flex-column'>
          ...
          <div id='content'>
            ...
            <div className='container-fluid'>
              {/* Page Heading  */}
              <h1 className='h3 mb-2 text-gray-800'>Discover - Fishing Regulations</h1>
              <p className='mb-4'>Data entry for fishing regulations on mobile app discover tab.</p>

              <div>
              <Link to='/fishingregulations/endangeredspecies' class='btn btn-primary btn-icon-split btn-sm mb-3'>
                <span class='text'>Endangered Species</span>
              </Link>
              </div>
              <div>
              <Link to='/fishingregulations/catchsizerules' class='btn btn-primary btn-icon-split btn-sm mb-3'>
                <span class='text'>Catch Size Rules</span>
              </Link>
              </div>
              <div>
              <Link to='/fishingregulations/bfarregulations' class='btn btn-primary btn-icon-split btn-sm mb-3'>
                <span class='text'>Local and National Regulations</span>
              </Link>
              </div>
